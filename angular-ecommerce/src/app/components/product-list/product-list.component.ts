...
export class ProductListComponent implements OnInit {
  ...
  handleListProducts() {
    //check if "id" param is available, if not , use default value
    ...
    // if we have a diff category id than previous, need to reset page number back to 1!
  ...
  handleSearchProducts(){
    ...
    // if we have a diff keyword than prev, set thePageNumber to 1
